...
<div id="upload" class="hidden fixed inset-0 h-fit flex flex-col items-center border drop-shadow-md shadow-lg modal-container bg-white w-1/2 mx-auto my-auto rounded z-50 animated faster">
    ...
    <form action="/upload" method="POST" enctype="multipart/form-data" id="upload-form">
        ...
        <div class="flex flex-col space-y-4 items-center mb-3 md:flex-row md:space-x-4 md:ml-9 md:mr-9 md:mt-3 md:items-end">
            <div class="flex flex-col w-3/5 space-y-2">
                ...
                <div id="upload-specific-container" class="hidden flex flex-col relative">
                    <input type="text" id="upload-specific" name="specific" placeholder="Enter specific type..." class="w-full flex border border-gray-700 rounded-[7px] outline outline-0 font-sans font-normal leading-tight text-sm text-gray-700 focus:ring-1 focus:outline-none focus:ring-gray-700 rounded-lg text-sm px-4 py-2.5 inline-flex placeholder:text-xs">
                    <label for="upload-specific" class="relative absolute -top-12 left-3 w-fit px-1 bg-white font-sans font-normal text-gray-700 text-[11px] leading-tight">
                        Please Specify
                    </label>
                </div>
                <div class="flex flex-col space-y-2 md:flex-row md:space-x-2 md:space-y-0">
                ...
                <div class="flex flex-col relative w-full">
                    <select id="upload-term" name="term" class="w-full flex border border-gray-700 rounded-[7px] outline outline-0 font-sans font-normal leading-tight text-sm text-gray-700 focus:ring-1 focus:outline-none focus:ring-gray-700 rounded-lg text-sm px-4 py-2.5 inline-flex">
                ...
                <div class="flex flex-col">
                    <div class="flex flex-col relative w-full">
                        ...
                        <button id="dropdownBgHoverButton" data-dropdown-toggle="dropdownBgHover" data-dropdown-placement="top" class="w-full flex justify-between border border-gray-700 rounded-[7px] outline outline-0 font-sans font-normal leading-tight text-sm text-gray-700 focus:ring-1 focus:outline-none focus:ring-gray-700 rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center" type="button">
                            Select authors (0 out of - selected)
                        ...
                        <div id="dropdownBgHover" class="z-10 hidden w-fit border border-gray-300 bg-white rounded-md shadow max-h-80 overflow-y-scroll">
                            <ul id="upload-author-list" class="p-3 space-y-1 text-sm text-gray-700" aria-labelledby="dropdownBgHoverButton">
                                {{-- Rendered by upload.js --}}
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div id="upload-file-container" class="flex flex-col w-4/5 justify-end items-center pb-3 md:flex-col-reverse md:w-2/5">
                <div id="upload-dropzone" class="flex flex-col space-y-2 h-24 w-3/4 justify-center items-center border-2 border-gray-300 border-dashed rounded-lg cursor-pointer mt-3 px-2 py-2 md:h-1/2">
    ...
    <div class="flex flex-row justify-end self-end space-x-2 mx-6 px-2 pb-3">
        <button id="upload-cancel" type="button" class="px-2 py-1.5 font-sans font-medium text-sm text-[#1976D2] hover:text-gray-400">CANCEL</button>
        <button id="upload-submit" type="button" class="px-2 py-1.5 font-sans font-medium text-sm text-[#1976D2] hover:text-gray-400">UPLOAD</button>
    </div>
</div>
